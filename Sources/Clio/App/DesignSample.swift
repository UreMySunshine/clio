...
enum DesignSample {
    ...
    private static func claudeCode(now: Date) -> ToolSnapshot {
        ...
        return ToolSnapshot(
            ...
            projects: [.day: [
                ProjectUsage(path: "/w/duchamp.worktrees/release", displayName: "duchamp/release",
                             tokens: 620_000, cost: 2.42),
                ProjectUsage(path: "/w/clio", displayName: "clio", tokens: 341_000, cost: 1.33),
                ProjectUsage(path: "/w/fx-data-web", displayName: "fx-data-web", tokens: 182_000, cost: 0.71),
                ProjectUsage(path: "/w/skill-manager", displayName: "skill-manager", tokens: 74_000, cost: 0.29),
                ProjectUsage(path: "/w", displayName: "workspace", tokens: 26_610, cost: 0.11),
            ]],
            dailyTokens: heatmap(now: now),
